...
import type { CompletionAuditRequest, CompletionAuditResult } from "../../core/index.js";

const MEANINGFUL_PROGRESS_TOOL_SET = new Set(["write", "edit", "bash", "read", "grep", "find", "ls"]);

export function isOpencodeCompletionAuditEnabled(): boolean {
...
export function opencodeHeuristicCompletionAudit(request: CompletionAuditRequest): CompletionAuditResult {
...
function isOpencodeVerificationCommand(command: string): boolean {
